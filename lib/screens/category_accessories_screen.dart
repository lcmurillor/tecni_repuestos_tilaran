...
class CategoryAccessoriesScreen extends StatelessWidget {
  ///Es una pantalla intermedia en la cual el usario puede especificar la categoría de accesorio
  ...
  const CategoryAccessoriesScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        ///Construción de la lista de categorias para mostar en la pantalla de accesorios.
        body: StreamBuilder(

            ///Hace un llamdo a la base de datos y resive una lista de categorias.
            stream: firebaseProvider.getAccessoriesCategory(),
